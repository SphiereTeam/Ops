<header class="main-header">
    ...
    <a href="index.php" class="logo">
        ...
        <span class="logo-lg"><b>HR</b>FMS</span>
    </a>
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown messages-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <small><i class="fa fa-clock-o"></i> 5 mins</small>
                                        ...
                                        <p>Do You like this new theme?</p>
                                    </a>
                                </li>
                                <!-- end message -->
                        ...
                        <small><i class="fa fa-clock-o"></i> 2 days</small>
                                        ...
                                        <p>Hello, im  <?php echo $username?><p>
                                    </a>
                                </li>
                            </ul>
                        </li>
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="http://myhr.dst-group.com/selfservice/EmpImages/<?php echo  sprintf("%'.06d", $user_id)?>.jpg" class="user-image" alt="User Image">
